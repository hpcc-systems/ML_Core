...
/**
 * Test oneHotEncoder with data which has valid categories
 * And encoder is constructed with key
 */
...
baseKey := testData.expKey;
encoder := Preprocessing.OneHotEncoder(key := baseKey);
